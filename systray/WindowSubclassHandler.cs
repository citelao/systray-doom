...
public class WindowSubclassHandler
{
    ...
    public WindowSubclassHandler(NoReleaseHwnd hwnd, WindowMessageHandler.WndProcDelegate wndProc)
        : this(hwnd, WindowMessageHandler.ToInternalDelegate(wndProc))
    {
        // No addl work.
    }

    internal WindowSubclassHandler(NoReleaseHwnd hwnd, WindowMessageHandler.WndProcDelegateInternal wndProc)
    {
