...
public partial class WindowSubclassHandler2
{
    ...
    public WindowSubclassHandler2(NoReleaseHwnd hwnd, UserDelegate wndProc)
        : this(hwnd, ToInternalDelegate(wndProc))
    {
        // No addl work.
    }

    internal unsafe WindowSubclassHandler2(NoReleaseHwnd hwnd, WndProcDelegate wndProc)
    {
