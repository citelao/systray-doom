...
var subclass = new WindowSubclassHandler(hwnd, (hwnd, msg, wParam, lParam) =>
{
    switch (msg)
    {
        ...
        case var value when value == taskbarCreatedWindowMessage:
    ...
    // Fall back to whatever the main window proc does.
    return null;
});
